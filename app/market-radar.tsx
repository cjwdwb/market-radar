...
export default function MarketRadar(){
  ...
  useEffect(()=>{
    ...
    const historyTimer=visible?setInterval(()=>setHistoryRefresh(n=>n+1),range==="15m"?15_000:60_000):undefined;
